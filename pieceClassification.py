...
# Model for Occupancy Classification (Resnet 101)
...
# Make Base Model
base_model = ResNet101(weights = 'imagenet', input_shape= (75, 75, 3), include_top = False, name = "pc-resnet101") # LOOK INTO 
...
# Model for Piece Classification (Inception v3)
...
# Make Base Model
base_model = InceptionV3(weights = 'imagenet', input_shape= (75, 75, 3), include_top = False, name = "pc-inception-v3")
