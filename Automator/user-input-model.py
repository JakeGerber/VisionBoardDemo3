...
def train_and_view(train: bool = True, use_oc: bool = True, num_epochs_piece: int = 50, num_epochs_occupancy: int = 3, occupancy_layer_amount: int = 3, piece_layer_amount: int = 3, learning_rate = 1e-4, filters = [16, 32, 64], batch_size=128, name=""):
    ...
    if (train and use_oc):
        ...
        for i in range(1, occupancy_layer_amount+1):
            print(i)
    ...
    if (train and not use_oc):  
        ...
        for i in range(1, piece_layer_amount+1):
            print(i)
...
if __name__ == "__main__":
    ...
    train = True
    train_and_view(train=train, use_oc=use_oc, num_epochs_piece=num_epochs_piece, piece_layer_amount=piece_layer_amount, learning_rate=learning_rate, filters=filters, name="piece_classifier1.keras")

    train = False
    train_result = train_and_view(train=train, use_oc=use_oc, num_epochs_piece=num_epochs_piece, piece_layer_amount=piece_layer_amount, learning_rate=learning_rate, filters=filters, name="piece_classifier1.keras")
    ...
    #current_data = {}
    piece_layer_amount = 3
    num_epochs_piece = 125

    #learning_rate = (1 / (10**y))

    train = True
    train_and_view(train=train, use_oc=use_oc, num_epochs_piece=num_epochs_piece, piece_layer_amount=piece_layer_amount, learning_rate=learning_rate, filters=filters, name="piece_classifier2.keras")

    train = False
    train_result = train_and_view(train=train, use_oc=use_oc, num_epochs_piece=num_epochs_piece, piece_layer_amount=piece_layer_amount, learning_rate=learning_rate, filters=filters, name="piece_classifier2.keras")
    ...
    for x in range(60, 91, 5): #Range of epochs
        for y in range(2, 7): # Learning Rate
            ...
            train = True
            train_and_view(train=train, use_oc=use_oc, num_epochs_piece=num_epochs_piece, piece_layer_amount=piece_layer_amount, learning_rate=learning_rate, filters=filters, name="piece_classifier.keras")

            train = False
            train_result = train_and_view(train=train, use_oc=use_oc, num_epochs_piece=num_epochs_piece, piece_layer_amount=piece_layer_amount, learning_rate=learning_rate, filters=filters, name="piece_classifier.keras")
